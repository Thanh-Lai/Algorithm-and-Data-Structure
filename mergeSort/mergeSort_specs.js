describe('mergeSort', function () {
    ...
    it('should sort the array', function () {
        let output = mergeSort([ 169, 152, 84, 146, 94, 181, 140, 74, 170 ])
    ...
    it('should sort negative numbers as well as positive numbers', function () {
        let output = mergeSort([ -54, -37, 79, 13, 1, 94, 67, -66, 43, -64 ])
    ...
    it('should work with random arrays', function () {
        let arr = Array.from(Array(Math.floor(Math.random() * 20)), () => Math.floor(Math.random() * 200) - 100)
